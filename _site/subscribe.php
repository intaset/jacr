...
<div class="j-header">
  <div class="name">
    <h1>Journal of Automation and Control Research (JACR)<br><p class="body">ISSN: 2368-6677</p></h1>
    <div class="oalink">
    ...
    <img src="../img/journals/j-jacr.jpg" class="j-img">
</div>
</div>

<div class="desktop jhead">
  <div class="name">
    <h1>Journal of Automation and Control Research (JACR)</h1>
    <div class="issn">
    <p class="body">ISSN: 2368-6677</p>
    <div class="oalink">
    <a href="/openaccess" target="blank" title="Avestia's Open Access">
          <img src="../img/j-oa.png" border="0" onmouseover="this.src='../img/j-oa-hover.png'" onmouseout="this.src='../img/j-oa.png'" class="j-oa">
    </a>
...
$confirmed = 0;
 ...
 // now we insert it into the database
  ...
  $subject = "Journal of Automation and Control Research (JACR)"; 
  $message = "Thank you for signing up to receive alerts for JACR - Journal of Automation and Control Research.
...
<div class="desktop jhead">
  ...
  <div class="main-content">
    ...
    <p class="body">Thank you for subscribing to JACR - Journal of Automation and Control Research. A confirmation email has been sent to your email. Please click on the confirmation link available in the email to confirm your subscription.</p>
